...
variable "vpc_environment" {
  description = "TUI VPC environment"
}
...
variable "asg_metrics" {
  description = "The metrics to collect on the ASG. Default is all of them."
  default = [
...
variable "certificate_body" {
  description = "TLS certificate PEM for load balancer"
}

variable "private_key" {
  description = "TLS private key PEM for load balancer"
}
